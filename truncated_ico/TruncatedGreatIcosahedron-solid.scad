// source=coordinates form=solid id =TruncatedGreatIcosahedron
solid_1 = TruncatedGreatIcosahedron();
p_describe(solid_1);
scale(20) show_solid(solid_1);

function Z() = TruncatedGreatIcosahedron();
function TruncatedGreatIcosahedron() = 
// source:  http://dmccooey.com/polyhedra/TruncatedGreatIcosahedron.txt
// generated by  http://kitwallace.co.uk/3d/solid-index.xq
let(C0 = 0.118033988749894848204586834366)
let(C1 = 0.309016994374947424102293417183)
let(C2 = 0.618033988749894848204586834366)
let(C3 = 0.690983005625052575897706582817)
let(C4 = 0.927050983124842272306880251548)
poly(name = "Truncated Great Icosahedron",
// 6 sided faces = 20
// 5 sided faces = 12
vertices = [
[ 0.0, -0.5,   C4],
